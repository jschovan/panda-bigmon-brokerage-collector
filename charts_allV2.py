...
def run(fidx):
    ...
    data = data.replace('#CREDITS_HREF0#',"%s/data/All_Actions_%s.html" % (PUBDIRURL, pnames[fidx]))
    ...
    data = data.replace('#CREDITS_HREF1#',"%s/data/User_Selected_a_Site_on_Site_%s.html"%(PUBDIRURL,pnames[fidx]))
    ...
    data = data.replace('#CREDITS_HREF2#',"%s/data/User_Selected_a_Site_on_Cloud_%s.html"%(PUBDIRURL,pnames[fidx]))
    ...
    data = data.replace('#CREDITS_HREF3#',"%s/data/User_Selected_a_Cloud_on_Site_%s.html"%(PUBDIRURL,pnames[fidx]))
    ...
    data = data.replace('#CREDITS_HREF4#',"%s/data/User_Selected_a_Cloud_on_Cloud_%s.html"%(PUBDIRURL,pnames[fidx]))
    ...
    data = data.replace('#CREDITS_HREF5#',"%s/data/Panda_Brokerage_Decision_on_Site_%s.html"%(PUBDIRURL,pnames[fidx]))
    ...
    data = data.replace('#CREDITS_HREF6#',"%s/data/Panda_Brokerage_Decision_on_Cloud_%s.html"%(PUBDIRURL,pnames[fidx]))
    ...
    data = data.replace('#CREDITS_HREF7#',"%s/data/User_Excluded_a_Site_%s.html"%(PUBDIRURL,pnames[fidx]))
    ...
    data = data.replace('#CREDITS_HREF8#',"%s/data/User_Excluded_a_Site_on_Site_%s.html"%(PUBDIRURL,pnames[fidx]))
    ...
    data = data.replace('#CREDITS_HREF9#',"%s/data/User_Excluded_a_Site_on_Cloud_%s.html"%(PUBDIRURL,pnames[fidx]))
