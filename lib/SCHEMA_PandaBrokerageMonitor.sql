...
CREATE INDEX "DL3_LD_CAT" ON DAILYLOGV3 ("LOGDATE", "CATEGORY") LOCAL;
CREATE INDEX "DL3_LD_CAT_JS" ON DAILYLOGV3 ("LOGDATE", "CATEGORY", "JOBSET") LOCAL;
CREATE INDEX "DL3_LD_CAT_SIT" ON DAILYLOGV3 ("LOGDATE", "CATEGORY", "SITE") LOCAL;
CREATE INDEX "DL3_LD_CAT_CL" ON DAILYLOGV3 ("LOGDATE", "CATEGORY", "CLOUD") LOCAL;
CREATE INDEX "DL3_LD_CAT_JS_SIT" ON DAILYLOGV3 ("LOGDATE", "CATEGORY", "JOBSET", "SITE") LOCAL;
CREATE INDEX "DL3_LD_CAT_JS_CL" ON DAILYLOGV3 ("LOGDATE", "CATEGORY", "JOBSET", "CLOUD") LOCAL;
-- CREATE INDEX "DL3_LD_CAT_JS_CTR" ON DAILYLOGV3 ("LOGDATE", "CATEGORY", "JOBSET", "COUNTRY") LOCAL;
